...
type
  ...
  CurlOffT* {.importc: "curl_off_t", header: "<curl/curl.h>".} = clonglong

  XferInfoCallback* = proc (clientp: pointer, dltotal, dlnow, ultotal, ulnow: CurlOffT): int32 {.cdecl.} 
  ...
  SSL_VERSION* = enum
    ...
    SSLVERSION_TLSv1_0, SSLVERSION_TLSv1_1, SSLVERSION_TLSv1_2, SSLVERSION_TLSv1_3,
    SSLVERSION_LAST
  TIMECOND* = enum
  ...
  INFO* = enum
    ...
    INFO_TOTAL_TIME = 0x00300000 + 3, 
    INFO_TOTAL_TIME_T = 0x600000 + 50, 
    INFO_NAMELOOKUP_TIME = 0x00300000 + 4,
...
const OPT_XFERINFODATA* = OPT_PROGRESSDATA
